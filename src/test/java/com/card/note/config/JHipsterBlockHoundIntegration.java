...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.card.note.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.card.note.security.DomainUserDetailsService", "createSpringSecurityUser");
